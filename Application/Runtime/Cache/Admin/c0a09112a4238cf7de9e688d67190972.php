...
<div class="fixed-empty"></div>
    <form method="post" name="formSearch" action="<?php echo U('liuyan');?>" id="formSearch">
        ...
        <tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <a class="btn del" href="<?php echo U('del_pinglun',array('id'=>$news['id']));?>"><span>删除</span></a>
                    </td>
