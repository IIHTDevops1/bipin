...
<div class="fixed-bar">
    <div class="item-title">
        <h3>分类管理</h3>
        <ul class="tab-base">
            <li><a href="<?php echo U('down_payments');?>" <?php if(empty($classification)): ?>class="current"<?php endif; ?>><span>全部大类</span></a></li>

            <li><a href="<?php echo U('down_payments_edit');?>"><span>添加</span></a></li>
        </ul>
    </div>
</div>
    ...
    <table class="table tb-type3" id="newslist">
        ...
        <tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <a class="btn" href="<?php echo U('down_payments_edit',array('id'=>$news['id']));?>"><span>编辑</span></a>
                        <a class="btn del" href="<?php echo U('down_payments_delete',array('id'=>$news['id']));?>"><span>删除</span></a>
                    </td>
