...
<div class="fixed-bar">
    <div class="item-title">
        <h3>视频管理</h3>
        <ul class="tab-base">
            <li><a href="<?php echo U('shipin_add');?>"><span>添加</span></a></li>
        </ul>
    </div>
</div>
<div class="fixed-empty"></div>
    <form method="post" name="formSearch" action="<?php echo U('shipin');?>" id="formSearch">
...
<form method='post' id="form_apply" action="">
    ...
    <table class="table tb-type3" id="newslist">
        ...
        <tr class="thead">
            ...
            <th class="w60">视频封面图</th>
            <th class="w60">视频标题</th>
            <th class="w60">作者</th>
            <th class="w60">视频简介</th>
            <!--<th class="w60">上传分类</th>-->
            <th class="w60">视频文件</th>
        ...
        <tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <video width="300" height="250" src="<?php echo ($news["workss"]); ?>" poster="<?php echo ($news["thumb"]); ?>" autoplay="autoplay" controls="controls" preload="none"></video>
                    ...
                    <td>
                        <a class="btn" href="<?php echo U('shipin_add',array('id'=>$news['id']));?>"><span>编辑</span></a>
                        <a class="btn del" href="<?php echo U('shipin_delete',array('id'=>$news['id']));?>"><span>删除</span></a>
