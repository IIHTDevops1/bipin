    ...
    <div class="page">
        ...
        <form id="edit_form" method="post" action="">
            <table class="table tb-type2">
                <tbody>
                <tr class="noborder">
                    <td class="required"><label class="validation" for="news_title">版本号：</label></td>
                ...
                <tr class="noborder">
                    <td class="required"><label class="validation" for="content">更新说明：</label></td>
                    <td class="vatop rowform">
                        <input id="content" name="content" type="text" class="txt valid" value="<?php echo ($news["content"]); ?>">
                    <td class="vatop tips"></td>
                </tr>
                <tr class="noborder">
                    <td class="required"><label class="validation" for="addtime">更新时间：</label></td>
                    <td class="vatop rowform">
                        <input id="addtime" name="addtime" type="text" class="txt valid" value="<?php echo ($news["addtime"]); ?>">
                    <td class="vatop tips"></td>
                </tr>
