...
<div class="fixed-bar">
    <div class="item-title">
        <h3>车型列表</h3>
        <ul class="tab-base">
            <li><a href="<?php echo U('blackaccount');?>" <?php if(empty($classification)): ?>class="current"<?php endif; ?>><span>全部车型</span></a></li>
            <!--<li><a href="<?php echo U('blackaccount');?>?classification=1" <?php if(($classification) == "1"): ?>class="current"<?php endif; ?>><span>信用卡</span></a></li>-->
            <!--<li><a href="<?php echo U('blackaccount');?>?classification=2" <?php if(($classification) == "2"): ?>class="current"<?php endif; ?>><span>贷款</span></a></li>-->
            <!--<li><a href="<?php echo U('blackaccount');?>?classification=3" <?php if(($classification) == "3"): ?>class="current"<?php endif; ?>><span>支付</span></a></li>-->
            <!--<li><a href="<?php echo U('blackaccount');?>?classification=4" <?php if(($classification) == "4"): ?>class="current"<?php endif; ?>><span>商机</span></a></li>-->
    ...
    <table class="table tb-type3" id="newslist">
        ...
        <tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <a class="btn" href="<?php echo U('blackaccount_edit',array('id'=>$news['id']));?>"><span>编辑</span></a>
                        <a class="btn del" href="<?php echo U('news_delete',array('id'=>$news['id']));?>"><span>删除</span></a>
                    </td>
