    ...
    <div class="page">
        ...
        <form id="edit_form" method="post" action="">
            <table class="table tb-type2">
                ...
                <tr class="noborder">
                    <td class="required"><label class="validation" for="content">提现比例：</label></td>
                    <td class="vatop rowform">
                        <input id="content" name="content" type="text" class="txt valid" value="<?php echo ($news["content"]); ?>"><br/>
                    (提现比例：戏币提现转换成现金的比例，大于0，小于1)
