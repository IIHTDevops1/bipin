...
<div class="fixed-bar">
    <div class="item-title">
        <h3>曲谱管理</h3>
        <ul class="tab-base">
            <li><a href="<?php echo U('qupu_add');?>"><span>添加</span></a></li>
        </ul>
    </div>
</div>
<div class="fixed-empty"></div>
    <form method="post" name="formSearch" action="<?php echo U('qupu');?>" id="formSearch">
                ...
                <!--<td>-->
                    <!--<select id="types" name="types" class="txt">-->
                        <!--<?php if($types == ''): ?>-->
                            ...
                            <!--<?php else: ?>-->
                            <!--<option value="<?php echo ($types); ?>"><?php echo (get_types($types)); ?></option>-->
                        <!--<?php endif; ?>-->
                        <!--<?php if(is_array($typess)): $i = 0; $__LIST__ = $typess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>-->
    ...
    <table class="table tb-type3" id="newslist">
        ...
        <tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <?php if(is_array($news["workss"])): $i = 0; $__LIST__ = $news["workss"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i; if($n != ''): ?><img src="<?php echo ($n); ?>" style="height: 50px;width:50px;"/>&nbsp;<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <td>
                        <a class="btn" href="<?php echo U('qupu_add',array('id'=>$news['id']));?>"><span>编辑</span></a>
                        <a class="btn del" href="<?php echo U('qupu_delete',array('id'=>$news['id']));?>"><span>删除</span></a>
