...
<div class="fixed-bar">
    <div class="item-title">
        <h3>汽车品牌</h3>
        <ul class="tab-base">
            <li><a href="<?php echo U('brand');?>" <?php if(empty($classification)): ?>class="current"<?php endif; ?>><span>全部品牌</span></a></li>
...
<div class="fixed-empty"></div>
    <form method="post" name="formSearch" action="<?php echo U('brand');?>" id="formSearch">

        <table class="tb-type1 noborder search">
            <tbody>
            <tr>
                <th><label for="type_name"> 品牌</label></th>
                <td><input type="text" value="<?php echo ($type_name); ?>" name="type_name" id="type_name" class="txt"></td>
