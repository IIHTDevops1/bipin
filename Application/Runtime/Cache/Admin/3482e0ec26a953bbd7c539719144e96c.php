    ...
    <div class="page">
        ...
        <form id="edit_form" method="post" action="">
            <table class="table tb-type2">
                <tbody>
                <!--<tr class="noborder">-->
                    <!--<td class="required"><label class="validation" for="news_title">客服微信号：</label></td>-->
                    <!--<td class="vatop rowform">-->
                        <!--<input id="news_title" name="news_title" type="text" class="txt valid" value="<?php echo ($news["news_title"]); ?>">-->
                    <!--<td class="vatop tips"></td>-->
                <!--</tr>-->
                <tr class="noborder">
                    <td class="required"><label class="validation" for="content">客服QQ号：</label></td>
                    <td class="vatop rowform">
                        <input id="content" name="content" type="text" class="txt valid" value="<?php echo ($news["content"]); ?>">
                    <td class="vatop tips"></td>
                </tr>
                <!--<tr class="noborder">-->
                    <!--<td class="required"><label class="validation" for="thumb">客服微信号：</label></td>-->
                    <!--<td class="vatop rowform">-->
                        <!--<input id="thumb" name="thumb" type="text" class="txt valid" value="<?php echo ($news["thumb"]); ?>">-->
                    <!--<td class="vatop tips"></td>-->
                <!--</tr>-->
                <!--<tr class="noborder">-->
                    <!--<td class="required"><label class="validation" for="beijing">客服QQ号：</label></td>-->
                    <!--<td class="vatop rowform">-->
                        <!--<input id="beijing" name="beijing" type="text" class="txt valid" value="<?php echo ($news["beijing"]); ?>">-->
                    <!--<td class="vatop tips"></td>-->
                <!--</tr>-->
