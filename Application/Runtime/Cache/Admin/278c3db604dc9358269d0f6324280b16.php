    ...
    <div class="page">
        ...
        <form id="edit_form" method="post" action="">
            <table class="table tb-type2">
                ...
                <tr class="noborder">
                    <td class="required"><label class="validation">内容详情：</label></td>
                    <td class="vatop rowform" colspan="2">
                        <input id="title" name="title" type="hidden" class="txt valid" value="关于我们">
                        <input id="type" name="type" type="hidden" class="txt valid" value="2">
                        <textarea id="content" name="content" style="width:700px;height:300px;"><?php echo ($news["content"]); ?></textarea>
                        <script src="/bipin/static/kindeditor/kindeditor.js" charset="utf-8"></script>
                        <script src="/bipin/static/kindeditor/lang/zh_CN.js" charset="utf-8"></script>
                        <script>
                            KindEditor.ready(function(K) {
                                var editor1 = K.create('textarea[name="content"]', {
                                    uploadJson : '/bipin/static/kindeditor/php/upload_json.php',
                                    fileManagerJson : '/bipin/static/kindeditor/php/file_manager_json.php',
