...
<div class="fixed-empty"></div>
    <form method="post" name="formSearch" action="<?php echo U('blackaccount');?>" id="formSearch">

        <table class="tb-type1 noborder search">
            <tbody>
            <tr>
                <!--<th><label for="news_title"> 标题</label></th>-->
...
//                                return;
                ...
                <td>
                    <select id="types" name="types" class="txt">
                        <?php if($types == ''): ?><option value="">请选择上传分类</option>
                            <?php else: ?>
                            <option value="<?php echo ($types); ?>"><?php echo (get_types($types)); ?></option><?php endif; ?>
                        <?php if(is_array($typess)): $i = 0; $__LIST__ = $typess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['type_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
...
<form method='post' id="form_apply" action="">
    ...
    <table class="table tb-type3" id="newslist">
        ...
        <tr class="thead">
            ...
            <th class="w60">需要戏币</th>
            <th class="w60">伴奏封面图</th>
            <th class="w60">伴奏标题</th>
            <th class="w60">作者</th>
            <th class="w60">伴奏简介</th>

            <th class="w60">伴奏文件</th>
            <th class="w60">上传时间</th>
            <!--<th class="w60">排序</th>-->
