...
class ChuanglanSmsApi {
	...
	const API_ACCOUNT='I1521664';//Get SMS Account  from  https://zz.253.com/site/login.html

	const API_PASSWORD='jKRyOwaJlM7170';//Get SMS Password  from https://zz.253.com/site/login.html
	/**
	 * 发送短信
	 *
