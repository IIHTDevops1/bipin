...
//Interface URL Used to send sendVariableSMS
	const API_VARIABLE_URL='http://smsbj1.253.com/msg/variable/json';
	
	//Interface URL Used to Query SMS balance
	const API_BALANCE_QUERY_URL='http://smssh1.253.com/msg/balance/json';

	const API_ACCOUNT='N8802327';//Get SMS Account  from  https://zz.253.com/site/login.html

	const API_PASSWORD='XPnafSxAgG4411';//Get SMS Password  from https://zz.253.com/site/login.html
	/**
	 * 发送短信
	 *
