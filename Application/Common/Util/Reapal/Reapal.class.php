...
class Reapal{
    ...
    function takeorder2()
    {
        ...
        while (list ($key, $val) = each ($this->parameter))
        {
            $sHtml.= "<input type='text' class='form-input' name='".$key."' value='".$val."'/><br />";
        }

        $sHtml = $sHtml."<input type='text' class='form-input' name='sign' value='".$this->mysign."'/><br />";
        $sHtml = $sHtml."<input type='text' class='form-input' name='sign_type' value='".$this->sign_type."'/>";
