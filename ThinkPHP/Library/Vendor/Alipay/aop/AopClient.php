	...
	*/
	public function pageExecute($request,$httpmethod = "POST") {
		...
		if ("GET" == strtoupper($httpmethod)) {
			...
			//拼接GET请求串
			$requestUrl = "https://openapi.alipay.com/gateway.do"."?".$preString;
	...
	protected function buildRequestForm($para_temp) {
		...
		$sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='https://openapi.alipay.com/gateway.do?charset=".trim($this->postCharset)."' method='POST'>";
